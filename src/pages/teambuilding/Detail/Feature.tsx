  ...
  return (
    <div className="teambuilding-feature">
      ...
      <div className="theme">
        ...
        <img
          className="img"
          src="https://ss0.bdstatic.com/70cFuHSh_Q1YnxGkpoWK1HF6hhy/it/u=3744429244,3279292678&fm=26&gp=0.jpg"
        />
        <div className="theme-desc">
          在秦皇岛一提到“赶海”，小编就有点小激动，相信很多秦皇岛人与小编一样，对这项活动那是相当的热爱。什么是赶海呢？赶海就是居住在海边的人们根据潮涨潮落的规律，赶在潮落的时机，到海岸的滩涂和礁石上打捞或采集海产品。说通俗点，就是去海边捡海鲜啦！
        </div>
      </div>
      <div className="place">
